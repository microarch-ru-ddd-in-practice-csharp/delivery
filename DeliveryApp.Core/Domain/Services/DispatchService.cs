...
public class DispatchService : IDispatchService
{
    ...
    public Result<Courier, Error> Dispatch(Order order, List<Courier> couriers)
    {
        ...
        if (fastestCourier == null) return Errors.ActualCourierWasNotFound();
    ...
    {
        public static Error ActualCourierWasNotFound()
        {
            return new Error("actual.courier.was.not.found",
