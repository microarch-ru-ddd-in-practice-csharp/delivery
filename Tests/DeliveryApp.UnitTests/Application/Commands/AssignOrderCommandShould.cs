...
public class AssignOrderCommandShould
{
    ...
    {         
        ...
        var order = new Order(Guid.NewGuid(), Location.CreateRandom(), new Volume(5));
        ...
        var handler = new AssignOrderCommandHandler(_orderRepositoryMock, _courierRepositoryMock, _unitOfWorkMock);
        ...
        await _orderRepositoryMock.Received(1).GetAnyCreatedOrderAsync(Arg.Any<CancellationToken>());
